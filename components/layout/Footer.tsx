    ...
    <footer className="bg-ink border-t border-cream/8">
      ...
      <div className="border-b border-cream/8">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="font-display text-4xl md:text-5xl text-cream leading-tight">
              READY TO GO FROM{" "}
              <span className="text-lime">HERE TO EVERYWHERE?</span>
            </p>
            <p className="text-cream/50 font-body mt-2 text-sm">
              Let&apos;s build your next campaign — digital, offline, or on-screen.
            </p>
          </div>
          <Link
            href="/contact"
            className="shrink-0 inline-flex items-center gap-2 bg-lime text-ink px-7 py-4 text-sm font-body font-bold uppercase tracking-[0.18em] hover:bg-lime-dim transition-colors whitespace-nowrap"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
          ...
          <div className="md:col-span-5">
            ...
            <p className="text-cream/40 text-sm font-body leading-relaxed max-w-sm mb-6">
              We build brands from Lucknow to the national stage — digital
              performance, offline presence, and on-screen storytelling under
              one roof. Est. 2019.
            </p>
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="text-cream/40 hover:text-lime transition-colors"
              >
